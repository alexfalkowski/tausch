...
- [`161fd1b`](https://github.com/alexfalkowski/tausch/commit/161fd1bd279f8265a72238269e6aa4e7f6f1f557) docs(ai): add AGENTS.md (#105)
- [`b0a615f`](https://github.com/alexfalkowski/tausch/commit/b0a615f732bd572a1a967bda4561cd3d7ecfac7f) build(license): move to mit (#104)
- [`c414958`](https://github.com/alexfalkowski/tausch/commit/c4149581053c627ffa2391e8e951fc1b65917fb5) build(ci): use latest published images (#103)
- [`d8d53f6`](https://github.com/alexfalkowski/tausch/commit/d8d53f6f641861f95c916be49c8f7be35320b110) build(ci): use latest published images (#102)
- [`0694d44`](https://github.com/alexfalkowski/tausch/commit/0694d44b7898ed708d85baf8299cd673c0401830) build(ci): use latest published images (#101)
- [`0520ad1`](https://github.com/alexfalkowski/tausch/commit/0520ad1d18f52cefce6e77daa83db61e9826888c) build(ci): use latest published images (#100)
- [`c239fa8`](https://github.com/alexfalkowski/tausch/commit/c239fa8fc51ea2c049f294e531d1666b3fbed982) build(deps): upgraded github.com/alexfalkowski/bin (#99)
- [`8903abb`](https://github.com/alexfalkowski/tausch/commit/8903abb7847f3126cce44a9c8c3625edd280e472) build(ci): use latest published images (#98)
- [`8a9423d`](https://github.com/alexfalkowski/tausch/commit/8a9423ddc29e43f7a95fa8bdb32cd791ae651ca1) build(ci): use latest published images (#97)
- [`d3de94f`](https://github.com/alexfalkowski/tausch/commit/d3de94f582f7f6eecb03e755fcab594659979b94) build(ci): use latest published images (#96)
- [`dbbad87`](https://github.com/alexfalkowski/tausch/commit/dbbad87d7d961fbc0b731bb013df319cb421c88e) build(deps): upgraded github.com/alexfalkowski/bin (#95)
- [`ae64e24`](https://github.com/alexfalkowski/tausch/commit/ae64e240b76416a0d1d7d5e04c1d9474cb9d5687) build(ci): use latest published images (#94)
- [`7ff4454`](https://github.com/alexfalkowski/tausch/commit/7ff44542aa75852f201f9a112606a0e8df015f48) build(ci): use latest published images (#93)
- [`14de797`](https://github.com/alexfalkowski/tausch/commit/14de79777e609c0342fd76e1c1721aea9a8bab73) build(ci): use latest published images (#92)
- [`a770ced`](https://github.com/alexfalkowski/tausch/commit/a770cedb1a2e2466641e33b770507df70dfe7959) build(ci): use latest published images (#91)
- [`a222b0d`](https://github.com/alexfalkowski/tausch/commit/a222b0df292c90e6d0f5730381a723cb8920afe7) build(deps): upgraded github.com/alexfalkowski/bin (#90)
- [`52c4481`](https://github.com/alexfalkowski/tausch/commit/52c4481dba470454dff03a848dd8e614482cbaf4) build(deps): upgraded github.com/alexfalkowski/bin (#89)
- [`eb295ce`](https://github.com/alexfalkowski/tausch/commit/eb295ce9028e44a35d9145f8803a664e9d98312e) build(ci): use latest published images (#88)
- [`cd39a6e`](https://github.com/alexfalkowski/tausch/commit/cd39a6e031bf74671298eaa4e599b072a3f2562c) build(ci): use latest published images (#87)
- [`26a92e4`](https://github.com/alexfalkowski/tausch/commit/26a92e41845b6b7fd3088ef590d9330234530b08) build(deps): upgraded github.com/alexfalkowski/bin (#86)
- [`d1a00f0`](https://github.com/alexfalkowski/tausch/commit/d1a00f01898ca489e9a507d154ea94bc7d4d3381) build(deps): upgraded github.com/alexfalkowski/bin (#85)
- [`96fd788`](https://github.com/alexfalkowski/tausch/commit/96fd788265a3c1a5abd826de663d3b08c11cdca7) build(ci): use latest published images (#84)
- [`fc731c0`](https://github.com/alexfalkowski/tausch/commit/fc731c0c215686a1aecb2559e26a1d07d0f3cdeb) build(deps): upgraded github.com/alexfalkowski/bin (#83)
- [`a520010`](https://github.com/alexfalkowski/tausch/commit/a520010dcdea0b9033be27807f217c16204841e9) build(ci): use latest published images (#82)
- [`bec5588`](https://github.com/alexfalkowski/tausch/commit/bec5588d27ef5c1dacfd3aca0f85d9afe00498b1) build(ci): use latest published images (#81)
- [`8f699f2`](https://github.com/alexfalkowski/tausch/commit/8f699f2045ce15f277719b93b7227bb26133e88e) build(ci): use latest published images (#80)
- [`843c46b`](https://github.com/alexfalkowski/tausch/commit/843c46bcb8b0464881d87becf1ee974e3323ac14) build(ci): use latest published images (#79)
- [`ef3caa3`](https://github.com/alexfalkowski/tausch/commit/ef3caa3bad3ec5d214b9a2801620b64e42aca926) build(ci): use latest published images (#78)
- [`3c6864b`](https://github.com/alexfalkowski/tausch/commit/3c6864b8e38e8a97596ff4fc871dfd58a0bcc388) build(ci): use latest published images (#77)
- [`4873ac0`](https://github.com/alexfalkowski/tausch/commit/4873ac098905f64a4a4d8950004e16974f76e9ce) build(ci): use latest published images (#76)
- [`701ed92`](https://github.com/alexfalkowski/tausch/commit/701ed92e679319bc75294315bc0051424ef5987e) build(ci): use latest published images (#75)
- [`f9e701d`](https://github.com/alexfalkowski/tausch/commit/f9e701d670449be64d810b8fd4e70291ddf41da9) build(ci): use latest published images (#74)
- [`fad083e`](https://github.com/alexfalkowski/tausch/commit/fad083edc50fb261fc07828026535e79532bacb2) build(ci): use latest published images (#73)
- [`4c8b620`](https://github.com/alexfalkowski/tausch/commit/4c8b6202f21d535baa1f01e3a014b4e844cdc5ee) build(deps): upgraded github.com/alexfalkowski/bin (#72)
- [`f0f1faf`](https://github.com/alexfalkowski/tausch/commit/f0f1fafbb216c50dd6cb69051781546e224b1eb2) build(ci): use latest published images (#71)
- [`ced2165`](https://github.com/alexfalkowski/tausch/commit/ced2165cf3031bfdbe42af4fbd8ddd6a953a4a2a) build(ci): use latest published images (#70)
- [`749a27c`](https://github.com/alexfalkowski/tausch/commit/749a27cf639af89514f3427fbe3f61cc24955407) build(ci): use latest published images (#69)
- [`dbfd3e0`](https://github.com/alexfalkowski/tausch/commit/dbfd3e02ab99323ade6da6eb7712d16a7abc3072) build(ci): use latest published images (#68)
- [`3b278a8`](https://github.com/alexfalkowski/tausch/commit/3b278a8ec028019ad0a44322bbe1d9ec3344ca95) build(ci): use latest published images (#67)
- [`ded01dd`](https://github.com/alexfalkowski/tausch/commit/ded01dd978c256a42c6fdee987952e9f7b525a00) build(ci): use latest published images (#66)
- [`8af26c7`](https://github.com/alexfalkowski/tausch/commit/8af26c79f927169bd2bc203996384bfef715b7bd) build(ci): use latest published images (#65)
- [`9be0ac9`](https://github.com/alexfalkowski/tausch/commit/9be0ac9d2d8d92946b24a8b7c6278fc5137d1026) build(ci): use latest published images (#64)
